...
class __TwigTemplate_f71d42b0430315044a4a60a4f36b354be2a9f23c50ac8b566b1662d9ed024529 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 326);
            echo "/";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 326);
            echo ".png\" title=\"";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "name", [], "any", false, false, false, 326);
            echo "\" /></span>';
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            // line 348
            echo "\t\thtml  += '<div class=\"input-group\"><span class=\"input-group-addon\"><img src=\"language/";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 348);
            echo "/";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 348);
            echo ".png\" title=\"";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "name", [], "any", false, false, false, 348);
            echo "\" /></span>';
\t\thtml  += '<input type=\"text\" name=\"ishibanner['+ banner_row +'][button_name][";
            // line 349
            echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 349);
