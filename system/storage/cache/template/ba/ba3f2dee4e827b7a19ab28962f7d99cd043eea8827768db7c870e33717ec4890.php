...
/* fabulous01/template/product/product.twig */
class __TwigTemplate_df4ecca8f783a41d436cd4b6e6f0e51332fd4f96cd2c983a104ab0ddce85cec1 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      ";
        ...
        if (($context["products"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo ($context["button_compare"] ?? null);
                echo "\" onclick=\"compare.add('";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 609);
                echo "');\"><i class=\"fa fa-exchange\"></i>                            
                      ...
                      <div class=\"caption\">
                          <h4><a href=\"";
                // line 619
                echo twig_get_attribute($this->env, $this->source, $context["product"], "href", [], "any", false, false, false, 619);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 619);
                echo "</a></h4>
                          <p class=\"description\">";
                // line 620
                echo twig_get_attribute($this->env, $this->source, $context["product"], "description", [], "any", false, false, false, 620);
                echo "</p>                    
                          ";
                // line 621
                if (twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 621)) {
                    // line 622
                    echo "                          <p class=\"price\"> ";
                    if ( !twig_get_attribute($this->env, $this->source, $context["product"], "special", [], "any", false, false, false, 622)) {
                        // line 623
                        echo "                            ";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "price", [], "any", false, false, false, 623);
                        echo "
                            ";
                    } else {
                        // line 624
                    ...
                    // line 625
                    echo "                            ";
                    if (twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 625)) {
                        echo " <span class=\"price-tax\">";
                        echo ($context["text_tax"] ?? null);
                        echo " ";
                        echo twig_get_attribute($this->env, $this->source, $context["product"], "tax", [], "any", false, false, false, 625);
                        echo "</span> ";
                    }
                    echo " 
                          </p>
...
";
    ...
    {
        return "fabulous01/template/product/product.twig";
    }
