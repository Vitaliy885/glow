...
class __TwigTemplate_62229b2189c50f66222deb9c1f5c4b9c8981e0e5517b887b9ee819cd3b8ea351 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t";
            // line 27
            if (twig_get_attribute($this->env, $this->source, $context["blog"], "image", [], "any", false, false, false, 27)) {
                echo " 
\t\t\t\t\t\t\t<a href=\"";
                // line 28
...
\t\t\t\t\t\t\t\t<img src=\"";
                // line 29
                echo twig_get_attribute($this->env, $this->source, $context["blog"], "image", [], "any", false, false, false, 29);
                echo "\" alt=\"";
...
\t\t\t\t\t\t\t<span class=\"date_month\">";
            // line 36
            echo twig_get_attribute($this->env, $this->source, $context["blog"], "date_added", [], "any", false, false, false, 36);
            echo "</span>
\t\t\t\t\t\t</div>\t\t\t\t\t\t
\t\t\t\t\t\t<h4 class=\"blog_title\"><a href=\"";
            ...
            echo "\">";
            echo twig_get_attribute($this->env, $this->source, $context["blog"], "title", [], "any", false, false, false, 38);
            echo "</a> </h4>\t
\t\t\t\t\t\t";
            // line 39
...
\t</script>
    ...
    {
        return array (  147 => 45,  138 => 41,  133 => 40,  129 => 39,  123 => 38,  118 => 36,  112 => 32,  107 => 31,  98 => 29,  94 => 28,  90 => 27,  82 => 24,  76 => 21,  72 => 20,  67 => 18,  63 => 16,  53 => 9,  50 => 8,  48 => 7,  43 => 5,  37 => 1,);
    }
